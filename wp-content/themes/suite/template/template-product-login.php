<?php 
    ...
    if(isPost()){
        ...
        $check = $model->productLogin($_POST['txt-username'],md5($_POST['txt-password'])) ;           
    } 
?>
<div class="col-xl-12 col-lg-12 col-md-12">
    <form action="" method="post" enctype="multipart/form-data" id="f_product_login" name="f_product_login" >
        <div class="login-form">
            ...
            <div class="button-row">
                <button type="submit" name="btn-product-login" id="btn-product-login" class="button button-primary button-large btn-login">
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        jQuery('#btn-product-login').click(function(e) {
