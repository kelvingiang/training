...
class Sponsor_Controler {

    public function __construct() {
        add_action('init', array($this, 'register_custom_post'));
        add_action('manage_edit-sponsor_columns', array($this, 'manage_columns'));
        add_action('manage_sponsor_posts_custom_column', array($this, 'render_columns'));

        add_filter('manage_edit-sponsor_sortable_columns', array($this, 'sortable_views_column'));
    ...
    public function register_custom_post() {
        ...
        $args = array(
            ...
            'show_ui' => true,
            'show_in_menu' => TRUE,
            'menu_icon' => PART_ICON . 'ad-icon.png',
            'query_var' => true,
            'rewrite' => true,
