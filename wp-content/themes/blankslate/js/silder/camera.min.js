        ...
        function jb(c) {
            ...
            if (!a(".imgLoaded", m).length) {
                ...
                if (v.length > l + 1 && !a(".imgLoaded", n).length) {
                    ...
                    n.prepend(a(A).attr("class", "imgLoaded").attr("alt", "Dong Phong").attr("title", "Dong Phong").css("visibility", "hidden"));
                    A.onload = function () {
                        q = A.naturalWidth;
                        w = A.naturalHeight;
                ...
                a.each(A, function (b, c) {
                    if (a("> div", j).eq(b).attr("data-thumb") != "") {
                        var d = a("> div", j).eq(b).attr("data-thumb"),
                            e = new Image;
                        e.src = d;
                        a("li.pag_nav_" + b, r).append(a(e).attr("class", "camera_thumb").attr({
                            alt: 'dongphong', title :'cty dong phong',
                        }).css({
                            position: "absolute",
                        }).animate({
                            opacity: 0
